...
| F-005c | `meta.Store` credentials + sessions | review | F-005b ✓ | Argon2id verifiers, robot secrets with mandatory expiry, PATs, sessions with idle+absolute bounds; hashes only, expiry enforced on read, subject deletion cascades. 11 added cases, 219 subtests total. Coverage 98.9% |
