...
// are five entries and there should never be many more.
...
//
// Nothing else is here. In particular the OCI base endpoint /v2/ is not: it is
// the client's authentication probe, and whether it answers 200 or 401 to an
// anonymous request is a disclosure decision for R-008 to make against ADR
// 0003 -- not a route to wave through now.
