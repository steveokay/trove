...
func Run(t *testing.T, f Factory) {
	...
	tests := []suiteCase{
		...
		{"ListContentNamesIncludesCachedContent", testListContentNamesIncludesCachedContent},
		{"ListContentNamesFiltersCachedContent", testListContentNamesFiltersCachedContent},
		{"ListContentNamesPaginateAcrossTheUnion", testListContentNamesPaginateAcrossTheUnion},
		{"ListContentNamesListsANameHoldingBothKindsOnce", testListContentNamesListsANameHoldingBothKindsOnce},
